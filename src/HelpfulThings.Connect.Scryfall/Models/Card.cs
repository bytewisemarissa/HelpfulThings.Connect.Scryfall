...
public class Card
{
    ...
    [JsonProperty("layout")] public required string Layout { get; set; }
    ...
    [JsonProperty("border_color")] public required string BorderColor { get; set; }
    ...
    [JsonProperty("frame")] public required string Frame { get; set; }
